...
window.onload = function() {
  ...
  "float ct = (cos(v.x*18.+T*2.)+cos(v.y*30.+T*20.));"+
  "v = mat2(cos(v.x*(15.+ct)),sin(v.x*(10.+ct)),cos(v.y*(10.+ct)),tan(v.y*(10.+ct)))*v;"+
...
function render() {
  ...
  gl.uniform1f(tuni,(Date.now()-startTime)/25000.);
